...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2016 at 05:13 PM
...
(4, 'Network Engineer', 'Network Engineer', '2', '2016-05-19', 0),
(5, 'Web Programmer', 'Web Programmer', '2', '2016-05-19', 0),
(6, 'System Analyst', 'System Analyst', '1', '2016-05-19', 0),
(7, 'Production Officer', 'Production Officer', '2', '2016-05-19', 0),
(8, 'Company Assistant', 'Company Assistant', '3', '2016-05-19', 0),
(9, 'Manager', 'manager', '1', '2016-05-19', 0);
...
(1, 3, 'Manager', 45000.00, 35.00, 10.00, 5000.00);
...
INSERT INTO `emp_job` (`id`, `job_title`, `job_spec`, `emp_status`, `job_category`, `joindate`, `job_location`, `basic_salary`, `shift`, `startdate`, `enddate`, `continue`, `created`) VALUES
...
(3, 2, 3, '2016-05-14 00:00:00', '2016-05-14 00:00:00', 1, 1, 1, 'sadf', '2016-05-16 00:00:00'),
...
ALTER TABLE `emp_attendance`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `day_wise_emp_attendance_status` (`eid`,`a_year`,`a_month`,`a_day`,`shiftid`,`in_out`), ADD KEY `empid` (`eid`,`shiftid`);
