    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<li class="active treeview">
              <a href="#">
                ...
                <ul class="treeview-menu">
                    <li <?php if ($active == "Company_Setup") echo 'class="active"'; ?>><?php echo anchor('Company_Setup', '<i class="fa fa-circle-o"></i>Company', 'title="Company_Setup"'); ?></li>
               </ul>
            </li>
            <li class="active treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li <?php if ($active == "designations") echo 'class="active"'; ?>><?php echo anchor('designations', '<i class="fa fa-circle-o"></i>Designation', 'title="Designation"'); ?></li>
                    <li <?php if ($active == "designations") echo 'class="active"'; ?>><?php echo anchor('empgrade/index', '<i class="fa fa-circle-o"></i>Grade', 'title="Grade"'); ?></li>
                </ul>
            </li>  
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li <?php if ($active == "employee") echo 'class="active"'; ?>><?php echo anchor('employee/emp_table_load', '<i class="fa fa-circle-o"></i>Employee List', 'title="Employee List"'); ?></li>                                
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li <?php if ($active == "employee") echo 'class="active"'; ?>><?php echo anchor('leave/index', '<i class="fa fa-circle-o"></i>Leave Manage', 'title="Leave Manage"'); ?></li>                                
                    <li <?php // if ($active == "employee") echo 'class="active"'; ?>><?php // echo anchor('employee/add_emp_gen_info', '<i class="fa fa-circle-o"></i>Add Employee', 'title="Add Employee"'); ?></li>                                
                </ul>
            </li>		
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li <?php if ($active == "employee") echo 'class="active"'; ?>><?php echo anchor('Attend_upload/index', '<i class="fa fa-circle-o"></i>Attendance Upload', 'title="Attendance Upload"'); ?></li>                                
                    <li <?php // if ($active == "employee") echo 'class="active"'; ?>><?php // echo anchor('employee/add_emp_gen_info', '<i class="fa fa-circle-o"></i>Add Employee', 'title="Add Employee"'); ?></li>                                
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><?php echo anchor("section/index", "Section", array("class" => "fa fa-circle-o")) ?></li>
